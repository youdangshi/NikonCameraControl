...
export function createDemoCamera() {
  ...
  return {
    ...
    async connect() {
      ...
      emit('status', { state: 'session_open', mode: 'demo', host: '演示相机', port: 0 });
      emit('camera_info', { model: 'Nikon Z30 (演示)', connection: 'Demo', ip: '本地模拟' });
      return { success: true, model: 'Nikon Z30 (演示)' };
    },
