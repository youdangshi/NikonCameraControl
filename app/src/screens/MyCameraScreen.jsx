...
const GUIDES = {
  ...
  staPc: {
    title: 'STA · PC 控制',
    intro: '相机和手机连接同一个路由器，并在相机端选择“连接到电脑”。该模式用于实时取景、遥控拍摄和照片传输。',
    steps: ['手机连接家庭或工作 WiFi。', '相机无线菜单选择“连接到电脑”，再连接到同一个网络。', '在相机屏幕查看分配的 IP 地址。', '返回妮妮填写相机 IP，选择“PC 控制”，端口保持 15740。', '点击连接，再进入实时取景。'],
    tips: '手机与相机必须处于同一网段，路由器不能开启客户端隔离。App 中选择的模式必须与相机端连接模式一致。',
  },
  staDevice: {
    title: 'STA · 智能设备',
